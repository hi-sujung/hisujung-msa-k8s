...
| [portfolio](https://github.com/hi-sujung/msa-portfolio) |  참여 대외활동 기반 포트폴리오 chatGPT API 활용 자동 생성 및 저장/조회/수정/삭제, rate limiter 적용 1일 자동생성 요청 횟수 제한                                          | [Deployment](https://github.com/hi-sujung/hisujung-msa-k8s/blob/main/k8s-manifest/portfolio/deployment.yaml), [Secret](https://github.com/hi-sujung/hisujung-msa-k8s/blob/main/k8s-manifest/portfolio/secret.yaml), [Service](https://github.com/hi-sujung/hisujung-msa-k8s/blob/main/k8s-manifest/portfolio/service.yaml) |
